package com.appleparty.ssily.common.aop;
...
public class LogAop {
    ...
    @Before("execution(* com.appleparty.ssily..*(..)) && !execution(* com.appleparty.ssily.common..*(..))")
    public void before(JoinPoint joinPoint){
        log.info("[log] {} -> {} 실행", joinPoint.getSignature().getDeclaringType().getSimpleName() ,joinPoint.getSignature().getName());
    }

    @After("execution(* com.appleparty.ssily..*(..)) && !execution(* com.appleparty.ssily.common..*(..))")
